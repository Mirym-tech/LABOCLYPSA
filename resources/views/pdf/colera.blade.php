...
<div class="titulo">
    ...
    <div class="titulo-tipo">ANÁLISIS DE CÓLERA</div>
</div>
...
<table style="width:calc(100% - 20px); margin:6px 10px; border-collapse:collapse; border:1px solid #000;">
    ...
    <tr>
        <td style="padding:3px 8px; font-size:9px; border-bottom:1px solid #ddd; border-right:1px solid #999;">Color</td>
        <td style="padding:3px 8px; font-size:9px; font-weight:bold; text-align:center; border-bottom:1px solid #ddd;">{{ strtoupper($r->color ?? '—') }}</td>
    </tr>
    <tr>
        <td style="padding:3px 8px; font-size:9px; border-bottom:1px solid #ddd; border-right:1px solid #999;">Consistencia</td>
        <td style="padding:3px 8px; font-size:9px; font-weight:bold; text-align:center; border-bottom:1px solid #ddd;">{{ strtoupper($r->consistencia ?? '—') }}</td>
    </tr>
    <tr>
        <td style="padding:3px 8px; font-size:9px; border-bottom:1px solid #ddd; border-right:1px solid #999;">Vibrio Cholerae (VC0-1)</td>
        <td style="padding:3px 8px; font-size:9px; font-weight:bold; text-align:center; border-bottom:1px solid #ddd;">{{ strtoupper($r->vc01 ?? '—') }}</td>
    </tr>
    <tr>
        <td style="padding:3px 8px; font-size:9px; border-bottom:1px solid #ddd; border-right:1px solid #999;">Vibrio Cholerae (VC01-1)</td>
        <td style="padding:3px 8px; font-size:9px; font-weight:bold; text-align:center; border-bottom:1px solid #ddd;">{{ strtoupper($r->vc01_1 ?? '—') }}</td>
    </tr>
    <tr>
        <td style="padding:3px 8px; font-size:9px; border-right:1px solid #999;">Vibrio Cholerae (VC0-139)</td>
        <td style="padding:3px 8px; font-size:9px; font-weight:bold; text-align:center;">{{ strtoupper($r->vc0139 ?? '—') }}</td>
    </tr>
</table>
