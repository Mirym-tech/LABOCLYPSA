...
<div class="flex flex-wrap items-start gap-2 mb-4">
    ...
    <div class="min-w-0 flex-1">
        <h1 class="text-lg sm:text-xl font-bold text-gray-800 leading-tight">Hematología — Orden <span class="text-blue-600 font-mono">{{ $oa->orden->numero_orden }}</span></h1>
...
<div x-data="{ tab: 'general' }">
    ...
    {{-- Botones pegados al fondo en móvil --}}
    <div class="sticky bottom-0 z-10 bg-white border-t border-gray-200 shadow-md
                -mx-3 lg:-mx-6 px-3 lg:px-6 py-3 mt-4 flex gap-3 flex-wrap">
