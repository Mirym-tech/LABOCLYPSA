...
<div class="flex flex-wrap items-start gap-2 mb-5">
    ...
    <h1 class="text-lg sm:text-xl font-bold text-gray-800 leading-tight min-w-0 flex-1">Análisis de Cólera — Orden <span class="text-blue-600 font-mono">{{ $oa->orden->numero_orden }}</span></h1>
    <a href="{{ route('pdf.colera', $oa) }}" target="_blank" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm font-medium flex-shrink-0">
